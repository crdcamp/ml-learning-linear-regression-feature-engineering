...
Some lighter requirements include using Scikit-Learn's `Pipeline` feature for cleaner code, and exploring some of the more simple methods of numeric transformations. More advanced numeric transformations will be explored on a case-by-case basis.
